...
function Dessert() {
    ...
    const getDessert = async () => {
      ...
      if (check) {
        ...
        const api = await fetch(`https://api.spoonacular.com/recipes/complexSearch?apiKey=${import.meta.env.VITE_REACT_APP_API_KEY}&query=dessert&number=20`);
        ...
        localStorage.setItem('dessert', JSON.stringify(randomRecipes));
        setDessert(randomRecipes);
